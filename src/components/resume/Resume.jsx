            ...
            <div className="w-11/12 mx-auto max-w-screen-2xl mt-10 lg:mt-20 lg:flex">
                ...
                <div className="2xl:ml-72">
                    ...
                    <div>
                        ...
                        <div className="w-2 h-2 rounded-full bg-black shrink-0 relative top-2"></div>
                        <p>
                            Provide Classroom support to clients using the mobile labs,
                        ...
                        <div className="w-2 h-2 rounded-full bg-black shrink-0 relative top-2"></div>
                        <p>
                            Resolve inquiries regarding desktop and laptop computers,
                            operating systems
                        </p>
                        </div>
                        <div className="flex items-start gap-x-2 mt-2">
                        ...
                        <div className="w-2 h-2 rounded-full bg-black shrink-0 relative top-2"></div>
                        <p>
                            Successfully to stay for the par-time position after
                            finishing the COOP Term
                        </p>
                        </div>
                    </div>
                    </div>
